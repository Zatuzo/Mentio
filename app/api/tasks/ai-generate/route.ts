...
import { aiLanguageInstruction } from '@/app/lib/ai-language';
...
- ${ctx.languageInstruction || 'Same language as the input'}
...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = buildSystemPrompt({
    ...
    existingTasks,
    languageInstruction: aiLanguageInstruction((session.user as any).aiLanguage),
  });
